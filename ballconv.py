...
class BallConv(Layer):
    def __init__(self, filters, kernel_size, strides=(1, 1), padding="same", alpha=1,
        ...
        super(BallConv, self).__init__(**kwargs)
    ...
    def call(self, inputs, mask=None):
        ...
        h = self.alpha * K.minimum(inputs_norm, self.rho) / self.rho
        return h * g
...
if __name__ == "__main__":
    ...
    conv_t = BallConv(filters=1, kernel_size=(2, 2), strides=(1, 1), padding="valid")(input_t)
