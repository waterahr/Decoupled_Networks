...
class MixConv(Layer):
    def __init__(self, filters, kernel_size, strides=(1, 1), padding="same",  alpha=1, beta=1,
    ...
    def build(self, input_shape):
        ...
        #initial_weights = K.ones((self.kernelSize[0], self.kernelSize[0], self.nInputPlane, self.nOutputPlane))
    ...
    def call(self, inputs, mask=None):
        ...
        h = self.alpha * inputs_norm + self.beta * K.log(1 + inputs_norm)
        return h * g
...
if __name__ == "__main__":
    ...
    conv_t = MixConv(filters=1, kernel_size=(2, 2), strides=(1, 1), padding="valid")(input_t)
